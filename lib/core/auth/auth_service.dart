...
String authErrorToRu(Object error) {
  ...
  // Бан номера: серверный хук отклоняет создание нового пользователя, и
  // Supabase заворачивает это в «Database error saving new user». Без ветки
  // человек видел бы общий «не удалось» и жал бы «ещё раз» без толку.
