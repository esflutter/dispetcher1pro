      ...
      final http.Response response = await http
          .post(
            ...
            body: jsonEncode(<String, dynamic>{
              'query': trimmed,
              'count': count,
              // Сужаем уровень детализации до «улицы» и «дома» — DaData
              // не возвращает регионы, города и районы. Это нужно
              // везде: и в формах создания заказа/карточки/услуги
              // (нужен конкретный адрес), и в фильтре каталога (поиск
              // «Москва» без улицы слишком обширный).
