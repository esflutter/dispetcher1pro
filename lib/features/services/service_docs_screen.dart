...
/// разворот с фотографией и страница с регистрацией, водительское с двух
/// сторон, документы на технику, сама техника с четырёх сторон с читаемыми
/// госномерами). Список согласован с заказчиком 06.08.2026 — те же пункты
/// перечисляет ИИ-помощник, менять надо в обоих местах. После отправки RPC
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 6.h),
                Text(
                  '1.  Разворот паспорта с фотографией и страница '
                  'с регистрацией. Это нужно, чтобы система убедилась '
                  'в вашей личности.\n'
                  '2.  Водительское удостоверение с двух сторон.\n'
                  '3.  Документы на технику.\n'
                  '4.  Техника с четырёх сторон с читаемыми госномерами.',
